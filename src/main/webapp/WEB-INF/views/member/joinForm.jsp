...
<html>
<head>
    <title>고객등록 페이지</title>
</head>
<link rel="stylesheet" href="<c:url value='/css/board.css'/>">
<body>
<jsp:include page = "../header.jsp" flush = "false"/>
<h1 style="text-align: center">고객등록화면</h1>
<div class="container">
    <form id="form" class="frm" action="" method="post">
        <label for="cust_no">고객번호 :</label><br>
        <input type="text" id="cust_no" name="cust_no" placeholder="" value="<c:out value='${cust_no}'/>" readonly="readonly">
        ...
        <button type="button" id="gohome" class="btn btn-modify"><i class="fa fa-edit"></i> 취소</button>
        <button type="button" id="joinBtn" class="btn btn-write"><i class="fa fa-pencil"></i> 등록</button>
    </form>
</div>
